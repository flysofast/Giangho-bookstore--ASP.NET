...
namespace QlSach
{
	...
	public partial class QlSachDbDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Insertappreg(appreg instance);
    partial void Updateappreg(appreg instance);
    partial void Deleteappreg(appreg instance);
    ...
    partial void Deletehoadon(hoadon instance);
		...
		public QlSachDbDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QlSachDbDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QlSachDbDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QlSachDbDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<appreg> appregs
		{
			get
			{
				return this.GetTable<appreg>();
			}
		}
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.TimSach")]
		public ISingleResult<TimSachResult> TimSach([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="NVarChar(50)")] string ts)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ts);
			return ((ISingleResult<TimSachResult>)(result.ReturnValue));
		}
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.TimSachTheoLoai")]
		public ISingleResult<TimSachTheoLoaiResult> TimSachTheoLoai([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="NVarChar(50)")] string ml)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ml);
			return ((ISingleResult<TimSachTheoLoaiResult>)(result.ReturnValue));
		}
	}
    ...
    partial void OnmadanhmucChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="danhmuc_loai", Storage="_danhmuc", ThisKey="madanhmuc", OtherKey="madanhmuc", IsForeignKey=true, DeleteRule="CASCADE")]
    ...
    partial void Onemail1Changed();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="email", Storage="_email1", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.appreg")]
	public partial class appreg : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnaddedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_app", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string app
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.apps")]
	public partial class app : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private string _app1;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void Onapp1Changing(string value);
    ...
    partial void OnappnameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="app", Storage="_app1", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string app1
		{
			get
			{
			...
			set
			{
				if ((this._app1 != value))
				{
					this.Onapp1Changing(value);
					this.SendPropertyChanging();
					this._app1 = value;
					this.SendPropertyChanged("app1");
					this.Onapp1Changed();
				}
			}
		}
	...
	public partial class TimSachResult
	{
	...
	public partial class TimSachTheoLoaiResult
	{
