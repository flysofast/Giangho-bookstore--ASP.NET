...
namespace QlSach.UC
{
    public partial class UCGiuaAdmin : System.Web.UI.UserControl
    {
        ...
        void BuildLpTrang(int st, string ml, string tk, int trang)
        {
            ...
            if (from > 2)
                LpTrang.Text = "<span class=\"short-left-moving-animation\" style=\"font-weight:bold;color:#333e40;\"><a " + rightStyle + "  href='admin.aspx?trang=" + 1 + "&tk="
                          + tk + "&ml=" + ml + "'>" + 1 + "</a> ◀ </span>";
            else
                LpTrang.Text = "<a " + rightStyle + "  href='admin.aspx?trang=" + 1 + "&tk="
                          + tk + "&ml=" + ml + "'>" + 1 + "</a>  ";

            for (int i = from; i <= to; i++)
            {
                if (i > 1 && i < st)
                    if (i == trang) LpTrang.Text = LpTrang.Text + "<a " + currentPageStyle + " href='admin.aspx?trang=" + i.ToString() + "&tk="
                           + tk + "&ml=" + ml + "'>" + i.ToString() + "</a>  ";
                    else
                        LpTrang.Text = LpTrang.Text + "<a " + normalStyle + " href='admin.aspx?trang=" + i.ToString() + "&tk="
                            + tk + "&ml=" + ml + "'>" + i.ToString() + "</a>  ";
            }
            ...
            if (to < st - 1)
                LpTrang.Text += "<span class=\"short-right-moving-animation\" style=\"font-weight:bold;color:#333e40;\"> ▶ <a " + rightStyle + "  href='admin.aspx?trang=" + st + "&tk="
                        + tk + "&ml=" + ml + "'>" + st + "</a></span>";
            else
                if (st > 1)
                    LpTrang.Text = LpTrang.Text + "<a " + rightStyle + "  href='admin.aspx?trang=" + st + "&tk="
                                + tk + "&ml=" + ml + "'>" + st + "</a>";
